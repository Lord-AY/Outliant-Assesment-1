const HomeContent = () => {
  return (
    <div className="mt-12">
      <div className="content-row grid grid-cols-2 gap-[200px] mb-12 lg:mb-24">
      ...
      <div className="content-row grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-[50px] h-auto lg:h-[500px] mb-12 lg:mb-48">
      ...
      <div className="content-row grid grid-cols-1 lg:grid-cols-7 gap-[50px] bg-gray lg:pb-12 pb-24">
        <div className="hidden lg:block lg:col-span-3">
          <div className="image-1 h-[500px] w-full -mt-24"></div>
        </div>
        <div className="col-span-1 pt-12 lg:pt-0 lg:col-span-4">
          <div className="flex h-full flex-col justify-center w-full lg:w-2/3">
            <h1 className="text-5xl font-bold mb-4">
              Lorem ipsum dolor sit amet consectetur
            </h1>
            <p className="text-primary mb-6">
